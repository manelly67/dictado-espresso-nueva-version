...
@Component({
  selector: 'app-dictadopt-principiante',
  templateUrl: './dictadopt-principiante.component.html',
  styleUrls: ['./dictadopt-principiante.component.css']
})
export class DictadoptPrincipianteComponent implements OnInit{
...
goBack(): void {
	...
	inicialnivel:number=27;
	finalnivel:number=28;
	espacio:string=' - ';
