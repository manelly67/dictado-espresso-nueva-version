...
@Component({
  selector: 'app-es-secuencial',
  templateUrl: './es-secuencial.component.html',
  styleUrls: ['./es-secuencial.component.css'],
  animations: [
    trigger('growUp', [ 
      transition(':enter', [
...
export class EsSecuencialComponent implements OnInit {
...
@Input() secuenciaF:number[] = [0];
	...
	return this.espalabraseleccionada;
	}
