...
@Component({
  selector: 'app-numeros-intermedio2',
  templateUrl: './numeros-intermedio2.component.html',
  styleUrls: ['./numeros-intermedio2.component.css']
})
export class NumerosIntermedio2Component implements OnInit {
