...
@Component({
  selector: 'app-spanish-test-int',
  templateUrl: './spanish-test-int.component.html',
  styleUrls: ['./spanish-test-int.component.css']
})
export class SpanishTestIntComponent implements OnInit{
...
this.location.back();
	...
	inicialnivel:number=25;
	finalnivel:number=26;
	espacio:string=' - ';
...
testbases = this.servitestService.captarTest2();
