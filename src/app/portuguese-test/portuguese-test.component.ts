...
@Component({
  selector: 'app-portuguese-test',
  templateUrl: './portuguese-test.component.html',
  styleUrls: ['./portuguese-test.component.css']
})
export class PortugueseTestComponent implements OnInit{
...
this.location.back();
	...
	inicialnivel:number=30;
	finalnivel:number=31;
	espacio:string=' - ';
...
testbases = this.servitestService.captarTest4();
