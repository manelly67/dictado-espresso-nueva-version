...
@Component({
  selector: 'app-spanish-test',
  templateUrl: './spanish-test.component.html',
  styleUrls: ['./spanish-test.component.css']
})
export class SpanishTestComponent implements OnInit {
...
this.location.back();
	...
	inicialnivel:number=24;
	finalnivel:number=25;
	espacio:string=' - ';
...
testbases = this.servitestService.captarTest();
