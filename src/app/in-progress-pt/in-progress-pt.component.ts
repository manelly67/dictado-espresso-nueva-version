...
@Component({
  selector: 'app-in-progress-pt',
  templateUrl: './in-progress-pt.component.html',
  styleUrls: ['./in-progress-pt.component.css']
})
export class InProgressPtComponent implements OnInit {
