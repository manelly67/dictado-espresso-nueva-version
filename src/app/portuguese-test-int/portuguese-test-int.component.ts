...
@Component({
  selector: 'app-portuguese-test-int',
  templateUrl: './portuguese-test-int.component.html',
  styleUrls: ['./portuguese-test-int.component.css']
})
export class PortugueseTestIntComponent implements OnInit {
...
this.location.back();
	...
	inicialnivel:number=31;
	finalnivel:number=32;
	espacio:string=' - ';
	nivelAjustado:number=this.inicialnivel;
...
testbases = this.servitestService.captarTest5();
